...
import com.arron_dbj.camera2demo.effect.EffectController;
import com.arron_dbj.camera2demo.view.CircularProgressView;
...
public class CameraActivity extends AppCompatActivity {
    ...
    private void recordComplete(int type, String path, Bitmap bitmap) {
        ...
        //打开相册或图库
        if (type == 0) {//视频
            Intent intent = new Intent(CameraActivity.this, EditVideoActivity.class);
            intent.setDataAndType(Uri.parse(tempPath), "video/mp4");
